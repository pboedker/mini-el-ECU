...
int Ain0_var =      A0; // - Not used
int AinKey =        A1; // Input pin for the keyboard encoding
int AinBatI =       A2; // Input pin for the battery current
int AinBatV =       A3; // Input pin for the full battery voltage
int Ain4_var =      A4; // I2C-SDA for 4x20 LCD Display
int Ain5_var =      A5; // I2C-SCL for 4x20 LCD Display
int D0_var =         0; // - Reserved for Serial Rx?
int D1_var =         1; // - Reserved for Serial Tx?
